...
public class MissionScreen extends ScreenAdapter {
    ...
    public MissionScreen(ZeppelinGame game) {
        this.game = game;
        backgroundImage = new Texture(Gdx.files.internal("DinMissionScreen.png"));
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.SPACE) && !isSpacePressed) {
            System.out.println("DinMissionScreen: Space key pressed. Progressing to next level.");
